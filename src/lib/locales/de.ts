...
"15 languages": "15 Sprachen",
  ...
  "Least practised": "Am wenigsten geübt",
  "Least seen (flashcards)": "Am seltensten gesehen (Karteikarten)",
  "Tested": "Getestet",
  "Seen": "Gesehen",
  "All groups": "Alle Gruppen",
  "{tested} tested · {wrong} wrong": "{tested} getestet · {wrong} falsch",
  "{n} wrong": "{n} falsch",
  "Shown {n} times in flashcards": "{n} Mal in Karteikarten gezeigt",
  "Dictionary store": "Wörterbuch-Shop",
  "Browse prebuilt dictionaries shared by the community. Adding one creates it and opens the import preview.": "Stöbere in fertigen Wörterbüchern aus der Community. Beim Hinzufügen wird es erstellt und die Importvorschau geöffnet.",
  "Search by name, language, or author…": "Nach Name, Sprache oder Autor suchen…",
  "Source language": "Ausgangssprache",
  "Target language": "Zielsprache",
  "Author": "Autor",
  "All authors": "Alle Autoren",
  "Loading store…": "Shop wird geladen…",
  "Try again": "Erneut versuchen",
  "The store is empty right now.": "Der Shop ist gerade leer.",
  "Store": "Shop",
  "Updated {time}": "Aktualisiert {time}",
  "Not loaded yet.": "Noch nicht geladen.",
  "Reload": "Neu laden",
  "Previously used link:": "Zuletzt verwendeter Link:",
  "Add": "Hinzufügen",
  "by": "von"
});