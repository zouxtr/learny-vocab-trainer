...
registerDictionary("de", {
  ...
  "Describe the words you want and we'll generate a draft list with the AI. You review, edit and deselect rows before importing — nothing is saved until you click Import words.": "Beschreibe die Wörter, die du möchtest, und wir erstellen mit der KI einen Entwurf. Du überprüfst, bearbeitest und wählst Zeilen ab, bevor du importierst — gespeichert wird erst, wenn du „Wörter importieren“ klickst.",
  "What should the words be about?": "Worüber sollen die Wörter sein?",
  "For example: restaurant phrases, household items, verbs of movement…": "Zum Beispiel: Restaurant-Sätze, Haushaltsgegenstände, Bewegungsverben …",
  "Describe the topic…": "Thema beschreiben …",
  "Number of words": "Anzahl der Wörter",
  "Generate": "Generieren",
  "Generating…": "Wird generiert …",
  "word generated.": "Wort generiert.",
  "words generated.": "Wörter generiert.",
  "Review them below before importing.": "Überprüfe sie unten, bevor du importierst.",
  "You've reached today's free generation limit. Try again tomorrow.": "Du hast das heutige kostenlose Generierungslimit erreicht. Versuche es morgen wieder.",
  "The AI couldn't produce a valid list. Please try again.": "Die KI konnte keine gültige Liste erstellen. Bitte versuche es erneut.",
  "AI generation is not configured on the server.": "Die KI-Generierung ist auf dem Server nicht konfiguriert.",
  "AI generation failed. Please try again.": "Die KI-Generierung ist fehlgeschlagen. Bitte versuche es erneut.",
  "Describe the words you want first.": "Beschreibe zuerst die gewünschten Wörter.",
  "{n} of {m} rows selected": "{n} von {m} Zeilen ausgewählt",
  "Include": "Einbeziehen",
  "Select all rows": "Alle Zeilen auswählen",
  "Include row {n}": "Zeile {n} einbeziehen",
  ...
  // Onboarding & help
  "Welcome to Lexi!": "Willkommen bei Lexi!",
  ...
  "Upload to Dropbox": "Zu Dropbox hochladen",
  "Download from Dropbox": "Von Dropbox herunterladen",
  "Last synced {time}": "Zuletzt synchronisiert {time}",
  "Cloud copy has newer changes.": "Die Cloud-Kopie enthält neuere Änderungen.",
  "This will replace your local data with the version from Dropbox. Continue?": "Dadurch werden deine lokalen Daten durch die Version von Dropbox ersetzt. Fortfahren?",
  "Uploading will overwrite unsynced changes on Dropbox. Continue?": "Beim Hochladen werden nicht synchronisierte Änderungen auf Dropbox überschrieben. Fortfahren?",
  "Continue": "Fortfahren",
  "Disconnect": "Trennen",
  "Uploaded your database to Dropbox": "Deine Datenbank wurde zu Dropbox hochgeladen",
  "Downloaded the latest version from the cloud": "Die neueste Version wurde aus der Cloud heruntergeladen",
  "Nothing to download yet — no file found on Dropbox.": "Noch nichts zum Herunterladen — auf Dropbox wurde keine Datei gefunden.",
...
"15 languages": "15 Sprachen",
  "A vocabulary trainer that turns your word lists into interactive study sessions. Everything runs locally in your browser — offline, no account needed.": "Ein Vokabeltrainer, der deine Wortlisten in interaktive Lern-Sitzungen verwandelt. Alles läuft lokal in deinem Browser – offline, kein Konto nötig.",
  "A word has a source term and a translation, plus optional grammar, example, group, and notes. Add words one by one or import them in bulk from a file, Google Sheet, or TSV link. Export to CSV anytime.": "Ein Wort hat einen Begriff und eine Übersetzung, plus optionale Angaben zu Grammatik, Beispiel, Gruppe und Notizen. Füge Wörter einzeln hinzu oder importiere sie in großen Mengen aus einer Datei, einem Google Sheet oder einem TSV-Link. Exportiere jederzeit als CSV.",
  "Add words": "Wörter hinzufügen",
  "Each dictionary is a vocabulary list with a language pair — a word language and a translation language, e.g. English → Spanish or Bulgarian → German. Keep one dictionary per topic and favorite or archive them.": "Jedes Wörterbuch ist eine Vokabelliste mit einem Sprachenpaar – einer Wortsprache und einer Übersetzungssprache, z. B. Englisch → Spanisch oder Bulgarisch → Deutsch. Behalte ein Wörterbuch pro Thema und stellen es auf Favorit oder archiviere es.",
  "Pick a dictionary and practice its words — flashcards, multiple choice, grammar, or typing — in either direction. Each word gets a spaced-repetition schedule, so the app shows you the words you need to review.": "Wähle ein Wörterbuch und übe seine Wörter – Karteikarten, Mehrfachauswahl, Grammatik oder Tippen – in beide Richtungen. Jedes Wort erhält einen Zeitplan für verteiltes Lernen, sodass die App dir die Wörter anzeigt, die du wiederholen musst.",
  "Sessions record your answers. The summary shows how many words you reviewed and your accuracy, and words you keep missing get scheduled again sooner.": "Sitzungen zeichnen deine Antworten auf. Die Zusammenfassung zeigt, wie viele Wörter du wiederholt hast und deine Genauigkeit, und Wörter, die du weiterhin falsch hast, werden früher wieder eingeplant.",
  "The entire interface is translated into 15 languages. Switch the UI language anytime from the top bar — it’s saved per device.": "Die gesamte Oberfläche ist in 15 Sprachen übersetzt. Wechsle die UI-Sprache jederzeit über die obere Leiste – sie wird pro Gerät gespeichert.",
  "Track progress": "Fortschritt verfolgen",
  "Your data never leaves your device unless you connect cloud sync.": "Deine Daten verlassen dein Gerät nie, außer du verbindest die Cloud-Synchronisierung.",
  "Your data stays in your browser by default. Optionally connect your own Dropbox to back the database up to the cloud — the app talks to Dropbox directly, with no server or account of its own.": "Deine Daten bleiben standardmäßig in deinem Browser. Verbinde optional dein eigenes Dropbox, um die Datenbank in der Cloud zu sichern – die App kommuniziert direkt mit Dropbox, ohne eigenen Server oder eigenes Konto.",
  "Settings": "Einstellungen",
  "Manage cloud backup and inspect your local storage.": "Cloud-Backup verwalten und lokalen Speicher prüfen.",
  "Storage & sync": "Speicher & Synchronisierung",
  "Your vocabulary starts here.": "Hier beginnt dein Wortschatz.",
  "your vocabulary": "dein Wortschatz",
  "Create your first dictionary — a word list between two languages — and add words as you go.": "Erstelle dein erstes Wörterbuch – eine Wortliste zwischen zwei Sprachen – und füge nach und nach Wörter hinzu."
});