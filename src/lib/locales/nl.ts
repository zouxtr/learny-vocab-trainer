...
registerDictionary("nl", {
  ...
  "Checking database connection…": "Databaseverbinding controleren…",
  "Failed to check database: {error}": "Databasecontrole mislukt: {error}",
  "SQLite ready (v{version}).": "SQLite klaar (v{version}).",
